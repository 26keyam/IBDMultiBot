...
class QueryClassifier(BaseModel):
    symptoms: bool = Field(None, description = "If the user query is about IBD Symptom or Nutrition Plan Inquiry, set it as True. If the user requests Factual Information, set this as False.")
